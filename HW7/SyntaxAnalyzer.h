...
private:
    ...
    int stepSize();
    void caseStatement();
    int caseTable(identifierBaseType expressionBaseType, Symbol expressionSymbol, int id);
    void caseChildrenStatement(identifierBaseType expressionBaseType, Symbol expressionSymbol, int id, int id2);
    void caseDefault(int id, int id2);
